...
describe('Create & push Docker image to GitHub Registry', () => {
  test('Override GitHub organization', async () => {
  ...
  test('Keep default GitHub organization', async () => {
  ...
  test('Converts owner name MockUser to lowercase mockuser', async () => {
    inputs.image = `${mockRepoName}/image-name`;
    inputs.registry = 'docker.pkg.github.com';
    inputs.tags = 'latest';
...
describe('Create & push Docker image to GCR', () => {
  test('Valid Docker inputs', async () => {
  ...
  test('Valid Docker inputs with two tags', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
  ...
  test('Valid Docker inputs with build args', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
    inputs.buildArgs = 'VERSION=1.1.1,BUILD_DATE=2020-01-14';
    inputs.dockerfile = 'Dockerfile.custom';
    inputs.labels = 'version=1.0,maintainer=step-security';
    imageFullName = getDefaultImageName();
    ...
    expect(docker.build).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        labels: ['version=1.0', 'maintainer=step-security']
      })
    );
  });

  test('Valid Docker inputs with build secrets', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
  ...
  test('Valid Docker inputs with platform', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest,   v1';
  ...
  test('Enable multi-platform', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
  ...
  test('Enable multi-platform skip push', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
    inputs.multiPlatform = 'true';
  ...
  test('Skip login when skipLogin is true', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
  ...
  test('Skip login warning when pushImage is false and no credentials provided', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
    inputs.tags = 'latest';
    inputs.pushImage = 'false';
  ...
  test('Enable appendMode to combine generated and custom tags', async () => {
    inputs.image = 'gcp-project/image';
    inputs.registry = 'gcr.io';
